...
export enum DashboardEvent {
  ...
  SET_PLUGIN_OBJECT_DETECTING_VIEWER_CONFIGURATION = "SET_PLUGIN_OBJECT_DETECTING_VIEWER_CONFIGURATION",
  SET_PLUGIN_OBJECT_DETECTING_MENU = "SET_PLUGIN_OBJECT_DETECTING_MENU",
}
